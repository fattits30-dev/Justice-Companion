...
test.describe("PWA Installation", () => {
    test("should display install prompt on desktop Chrome", async ({ page, browserName, }) => {
        // Only test PWA installation on Chromium browsers (Chrome, Edge)
        test.skip(browserName !== "chromium", "PWA install testing only for Chromium");
    ...
    test("should have valid PWA Lighthouse score (simulation)", async ({ page, browserName, }) => {
        test.skip(browserName !== "chromium", "Lighthouse testing only for Chromium");
        await loginWithSeededUser(page);
        await page.goto("/", { waitUntil: "networkidle" });
