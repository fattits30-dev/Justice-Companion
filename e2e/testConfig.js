 ...
 */
const deterministicPassword = process.env.DETERMINISTIC_E2E_PASSWORD || generateTestPassword();
...
export const TEST_CONFIG = {
    ...
    credentials: {
        e2eTest: {
            ...
            firstName: process.env.TEST_USER_FIRST_NAME || deterministicE2EUser.firstName,
            lastName: process.env.TEST_USER_LAST_NAME || deterministicE2EUser.lastName,
        },
        demo: {
