...
test.describe("AI Chat Functionality", () => {
    ...
    test("should handle document upload in chat", async ({ page }) => {
        ...
        if (await uploadButton.isVisible()) {
            ...
            await page.setInputFiles('input[type="file"]', {
                ...
                mimeType: "text/plain",
                buffer: Buffer.from("This is a sample employment contract for testing purposes."),
            });
            // Message should appear about document upload
            await expect(page.locator("text=document,uploaded,file,analyzing")).toBeVisible({ timeout: 10000 });
        }
    });
    ...
    test("should handle long messages", async ({ page }) => {
        ...
        await expect(page.locator("text=grievance procedure,ACAS,EAT,Employment Tribunal")).toBeVisible({ timeout: 30000 });
    });
});
