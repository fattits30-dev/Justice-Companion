...
- Support for 10 AI providers (OpenAI, Anthropic, Hugging Face, Qwen, Google, Cohere, Together, Anyscale, Mistral, Perplexity)
...
class AIProviderConfigService:
    ...
    def list_all_providers_metadata(self) -> Dict[str, AIProviderMetadata]:
        """
