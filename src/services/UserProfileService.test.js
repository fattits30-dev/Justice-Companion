...
describe("UserProfileService", () => {
    ...
    describe("getProfile()", () => {
        ...
        it("should log PII access when reading encrypted fields", () => {
            ...
            const accessLog = logs.find((log) => log.event_type === "profile.pii_access");
    ...
    describe("updateProfile()", () => {
        ...
        it("should log profile update event", () => {
            ...
            const logs = auditLogger.getAllLogs();
            const updateLog = logs.find((log) => log.event_type === "profile.update");
    ...
    describe("GDPR Compliance", () => {
        ...
        it("should maintain audit trail of profile changes", () => {
            ...
            const logs = auditLogger.getAllLogs();
            const updateLogs = logs.filter((log) => log.event_type === "profile.update");
