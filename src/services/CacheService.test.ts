...
describe('CacheService', () => {
  ...
  describe('Pattern Invalidation', () => {
    ...
    it('should handle complex patterns', async () => {
      ...
      await cacheService.getCached('case:123:evidence:1', () => fetchFn('case:123:evidence:1'));
      expect(fetchFn).toHaveBeenCalledWith('case:123:evidence:1');

      await cacheService.getCached('case:456:evidence:1', () => fetchFn('case:456:evidence:1'));
