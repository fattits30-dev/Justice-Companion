...
describe('StartupMetrics', () => {
  ...
  describe('recordPhase', () => {
    it('should record timestamps for each phase', () => {
      ...
      expect(timestamps.criticalServicesReady).toBeGreaterThanOrEqual(timestamps.loadingWindowShown);
    });
  ...
  describe('phase deltas', () => {
    it('should calculate phase deltas correctly', (done) => {
      ...
      setTimeout(() => metrics.recordPhase('criticalHandlersRegistered'), delays.criticalHandlersRegistered);
      setTimeout(() => metrics.recordPhase('mainWindowShown'), delays.mainWindowShown);
      setTimeout(() => metrics.recordPhase('nonCriticalServicesReady'), delays.nonCriticalServicesReady);
      setTimeout(() => {
