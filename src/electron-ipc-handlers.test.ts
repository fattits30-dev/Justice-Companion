...
describe("IPC Handlers", () => {
  ...
  function setupTestHandlers() {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: CaseCreateRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: CaseGetByIdRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, _request: CaseGetAllRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: CaseUpdateRequest) => {
        try {
          const updatedCase = mockCaseService.updateCase(
            request.id,
            request.input,
          );
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: CaseDeleteRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: CaseCloseRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, _request: CaseGetStatisticsRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: EvidenceCreateRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: EvidenceGetByIdRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: EvidenceGetAllRequest) => {
        try {
          const allEvidence = mockEvidenceRepository.findAll(
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: EvidenceGetByCaseRequest) => {
        try {
          const caseEvidence = mockEvidenceRepository.findByCaseId(
            request.caseId,
          );
          ...
          return {
            ...
            error:
              error instanceof Error
                ? error.message
                : "Failed to get evidence for case",
          };
        }
      },
    );
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: EvidenceUpdateRequest) => {
        try {
          const updatedEvidence = mockEvidenceRepository.update(
            request.id,
            request.input,
          );
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: EvidenceDeleteRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, _request: AICheckStatusRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: AIChatRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, _request: ProfileGetRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: ProfileUpdateRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, _request: ModelGetAvailableRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, _request: ModelGetDownloadedRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: ModelIsDownloadedRequest) => {
        try {
          const downloaded = mockModelDownloadService.isModelDownloaded(
            request.modelId,
          );
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: ModelDeleteRequest) => {
        try {
          const deleted = await mockModelDownloadService.deleteModel(
            request.modelId,
          );
    ...
    mockIpcMain.handle("facts:store", async (_event: any, params: any) => {
      try {
        ...
        return {
          success: false,
          error:
            error instanceof Error ? error.message : "Failed to store fact",
        };
      }
    });
    ...
    mockIpcMain.handle(
      "facts:get",
      async (_event: any, caseId: number, factType?: string) => {
        try {
          let facts;
          if (factType) {
          ...
          return {
            success: false,
            error:
              error instanceof Error ? error.message : "Failed to get facts",
          };
        }
      },
    );
    ...
    mockIpcMain.handle("facts:count", async (_event: any, caseId: number) => {
      try {
        ...
        return {
          success: false,
          error:
            error instanceof Error ? error.message : "Failed to get fact count",
        };
      }
    });
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: ConversationCreateRequest) => {
        try {
          const conversation = mockChatConversationService.createConversation(
            request.input,
          );
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: ConversationGetRequest) => {
        try {
          const conversation = mockChatConversationService.getConversation(
            request.id,
          );
          return { success: true, data: conversation };
        } catch (error) {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: ConversationGetAllRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: ConversationGetRecentRequest) => {
        try {
          const conversations =
            mockChatConversationService.getRecentConversationsByCase(
              request.caseId,
              request.limit,
            );
          return { success: true, data: conversations };
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: ConversationLoadWithMessagesRequest) => {
        try {
          const conversation = mockChatConversationService.loadConversation(
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: ConversationDeleteRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: MessageAddRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, _request: GDPRExportUserDataRequest) => {
        try {
          const cases = mockCaseRepository.findAll();
          const evidence = mockEvidenceRepository.findAll();
          const conversations =
            mockChatConversationService.getAllConversations();
          ...
          for (const conv of conversations) {
            const convWithMessages =
              mockChatConversationService.loadConversation(conv.id);
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: GDPRDeleteUserDataRequest) => {
        try {
          if (request.confirmation !== "DELETE_ALL_MY_DATA") {
            return {
              success: false,
              error:
                'Invalid confirmation string. Must be "DELETE_ALL_MY_DATA".',
            };
          }
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: FileSelectRequest = {}) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, _request: FileUploadRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: FileViewRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: FileDownloadRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: FilePrintRequest) => {
        try {
          const result = await mockShell.openPath(request.filePath);
          if (result) {
            return {
          ...
          return {
            ...
            error:
              error instanceof Error
                ? error.message
                : "Failed to open file for printing",
          };
        }
      },
    );
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, _request: FileEmailRequest) => {
        try {
    ...
    mockIpcMain.handle(
      ...
      async (_event: any, request: AIStreamStartRequest) => {
        try {
          const streamId = `stream-${Date.now()}`;
          await mockAIServiceFactory.streamChat({
            messages: request.messages as any,
          });
    ...
    describe("AI_CHAT", () => {
      it("should process chat request successfully", async () => {
        ...
        const request: AIChatRequest = {
          messages: [{ role: "user", content: "What is unfair dismissal?" }],
          caseId: 1,
        };
      ...
      it("should handle AI service errors", async () => {
        mockAIServiceFactory.chat.mockRejectedValue(
  ...
  describe("Model Handlers", () => {
    ...
    describe("MODEL_IS_DOWNLOADED", () => {
      it("should check if model is downloaded", async () => {
        ...
        mockModelDownloadService.getModelPath.mockReturnValue(
          "/path/to/model.gguf",
        );
  ...
  describe("Facts Handlers", () => {
    ...
    describe("facts:get", () => {
      ...
      it("should get facts filtered by category", async () => {
        ...
        expect(result.success).toBe(true);
        expect(mockCaseFactsRepository.findByCategory).toHaveBeenCalledWith(
          1,
          "timeline",
        );
      });
  ...
  describe("Integration Tests", () => {
    ...
    it("should handle case creation -> evidence creation flow", async () => {
      ...
      const caseResult = await invokeHandler<any>(
        IPC_CHANNELS.CASE_CREATE,
        caseRequest,
      );
      ...
      const evidenceResult = await invokeHandler<any>(
        IPC_CHANNELS.EVIDENCE_CREATE,
        evidenceRequest,
      );
    ...
    it("should handle case -> facts -> retrieval flow", async () => {
      ...
      const getFactsResult = await invokeHandler<any>(
        "facts:get",
        caseResult.data.id,
      );
    ...
    it("should handle update -> get flow", async () => {
      ...
      const updateResult = await invokeHandler<any>(
        IPC_CHANNELS.CASE_UPDATE,
        updateRequest,
      );
      ...
      const getResult = await invokeHandler<any>(
        IPC_CHANNELS.CASE_GET_BY_ID,
        getRequest,
      );
  ...
  describe("Error Propagation", () => {
    ...
    it("should handle network errors in AI handlers", async () => {
      mockAIServiceFactory.checkConnection.mockRejectedValue(
  ...
  describe("Handler Registration", () => {
    it("should register all case handlers", () => {
      ...
      expect(registeredHandlers.has(IPC_CHANNELS.CASE_GET_STATISTICS)).toBe(
        true,
      );
    });
    ...
    it("should register all evidence handlers", () => {
      ...
      expect(registeredHandlers.has(IPC_CHANNELS.EVIDENCE_GET_BY_ID)).toBe(
        true,
      );
      expect(registeredHandlers.has(IPC_CHANNELS.EVIDENCE_GET_ALL)).toBe(true);
      expect(registeredHandlers.has(IPC_CHANNELS.EVIDENCE_GET_BY_CASE)).toBe(
        true,
      );
    ...
    it("should register all model handlers", () => {
      ...
      expect(registeredHandlers.has(IPC_CHANNELS.MODEL_GET_AVAILABLE)).toBe(
        true,
      );
      expect(registeredHandlers.has(IPC_CHANNELS.MODEL_GET_DOWNLOADED)).toBe(
        true,
      );
      expect(registeredHandlers.has(IPC_CHANNELS.MODEL_IS_DOWNLOADED)).toBe(
        true,
      );
  ...
  describe("Conversation Handlers", () => {
    ...
    describe("CONVERSATION_CREATE", () => {
      it("should create conversation with case ID", async () => {
        ...
        expect(
          mockChatConversationService.createConversation,
        ).toHaveBeenCalledWith(request.input);
      });
    ...
    describe("CONVERSATION_GET", () => {
      it("should return conversation by ID", async () => {
        ...
        mockChatConversationService.getConversation.mockReturnValue(
          mockConversation,
        );
    ...
    describe("CONVERSATION_GET_RECENT", () => {
      it("should return recent conversations for case", async () => {
        ...
        mockChatConversationService.getRecentConversationsByCase.mockReturnValue(
          mockConversations,
        );
    ...
    describe("CONVERSATION_LOAD_WITH_MESSAGES", () => {
      it("should load conversation with messages", async () => {
        ...
        mockChatConversationService.loadConversation.mockReturnValue(
          mockConvWithMessages,
        );

        const request: ConversationLoadWithMessagesRequest = {
          conversationId: 1,
        };
        const result = await invokeHandler<any>(
          IPC_CHANNELS.CONVERSATION_LOAD_WITH_MESSAGES,
    ...
    describe("CONVERSATION_DELETE", () => {
      it("should delete conversation successfully", async () => {
        mockChatConversationService.deleteConversation.mockReturnValue(
          undefined,
        );
        ...
        expect(result.success).toBe(true);
        expect(
          mockChatConversationService.deleteConversation,
        ).toHaveBeenCalledWith(1);
      });
    ...
    describe("MESSAGE_ADD", () => {
      it("should add message to conversation", async () => {
        ...
        expect(result.success).toBe(true);
        expect(result.data).toEqual(mockConversation);
        expect(mockChatConversationService.addMessage).toHaveBeenCalledWith(
          request.input,
        );
      });
  ...
  describe("GDPR Handlers", () => {
    ...
    describe("GDPR_EXPORT_USER_DATA", () => {
      ...
      it("should include all data types in export", async () => {
        ...
        mockUserProfileService.getProfile.mockReturnValue({
          id: 1,
          name: "User",
          email: null,
          createdAt: "2025-10-08T00:00:00Z",
  ...
  describe("AI Streaming Handlers", () => {
    ...
    describe("AI_STREAM_START", () => {
      ...
      it("should handle stream initiation errors", async () => {
        mockAIServiceFactory.streamChat.mockRejectedValue(
          new Error("AI service unavailable"),
        );
