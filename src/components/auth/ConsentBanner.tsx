      ...
      <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={isLoading}
            className="px-4 py-2 text-sm font-medium text-white bg-secondary-700 rounded-md hover:bg-secondary-600 focus:outline-hidden focus:ring-2 focus:ring-gray-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            Decline
          </button>
          ...
          <button
            ...
            disabled={isLoading}
            className="px-4 py-2 text-sm font-medium text-white bg-secondary-600 rounded-md hover:bg-secondary-700 focus:outline-hidden focus:ring-2 focus:ring-secondary-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
          ...
          <button
            ...
            disabled={isLoading}
            className="p-2 text-white/90 hover:text-white focus:outline-hidden focus:ring-2 focus:ring-gray-500 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
