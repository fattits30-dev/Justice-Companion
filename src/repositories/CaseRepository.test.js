    ...
    describe("Backward Compatibility", () => {
        it("should handle legacy plaintext descriptions", () => {
            ...
            const result = testDbHelper
                .getDatabase()
                .prepare(`INSERT INTO cases (title, case_type, description, status)
         VALUES (?, ?, ?, ?)`)
        ...
        it("should throw when encryption service is not configured", () => {
            const repoWithoutEncryption = new CaseRepository(undefined);
            expect(() => repoWithoutEncryption.create({
