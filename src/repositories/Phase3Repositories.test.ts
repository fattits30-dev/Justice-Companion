...
describe('UserProfileRepository', () => {
  ...
  it('should encrypt name and email when updating profile', () => {
    ...
    const storedProfile = db.prepare('SELECT name, email FROM user_profile WHERE id = 1').get() as any;
  ...
  it('should not log PII in audit details', () => {
    ...
    const auditLogs = db.prepare('SELECT details FROM audit_logs').all() as any[];
...
describe('LegalIssuesRepository', () => {
  ...
  it('should encrypt description field', () => {
    ...
    const storedIssue = db.prepare('SELECT description FROM legal_issues WHERE id = ?').get(issue.id) as any;
...
describe('TimelineRepository', () => {
  ...
  it('should encrypt description field', () => {
    ...
    const storedEvent = db.prepare('SELECT description FROM timeline_events WHERE id = ?').get(event.id) as any;
