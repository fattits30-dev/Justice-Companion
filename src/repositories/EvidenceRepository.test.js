...
describe("EvidenceRepository with Encryption", () => {
    ...
    beforeEach(async () => {
        ...
        const auditLogger = new (await import("../services/AuditLogger.ts")).AuditLogger(testDb.getDatabase());
    ...
    describe("Decryption on Read Operations", () => {
        ...
        it("should decrypt all evidence content in findByCaseId", () => {
            ...
            const createdIds = evidenceItems.map((e) => evidenceRepo.create({
                caseId: testCaseId,
                ...e,
            }).id);
    ...
    describe("Backward Compatibility", () => {
        it("should handle legacy plaintext content", () => {
            ...
            const result = testDb
                .getDatabase()
                .prepare(`INSERT INTO evidence (case_id, title, evidence_type, content)
         VALUES (?, ?, ?, ?)`)
