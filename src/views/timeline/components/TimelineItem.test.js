...
describe("TimelineItem", () => {
    ...
    describe("Rendering", () => {
        it("should render deadline title and case title", () => {
            ...
            render(<TimelineItem deadline={deadline} onEdit={mockOnEdit} onComplete={mockOnComplete} onDelete={mockOnDelete} onCaseClick={mockOnCaseClick}/>);
        ...
        it("should not render description section when null", () => {
            ...
            const { container } = render(<TimelineItem deadline={deadline} onEdit={mockOnEdit} onComplete={mockOnComplete} onDelete={mockOnDelete} onCaseClick={mockOnCaseClick}/>);
