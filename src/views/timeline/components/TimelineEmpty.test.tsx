...
describe('TimelineEmpty', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render add deadline button', () => {
      ...
      expect(screen.getByRole('button', { name: /add your first deadline/i })).toBeInTheDocument();
    });
  ...
  describe('Interaction', () => {
    it('should call onAddClick when button is clicked', async () => {
      ...
      const addButton = screen.getByRole('button', { name: /add your first deadline/i });
  ...
  describe('Visual Design', () => {
    it('should render with centered layout', () => {
      const { container } = render(<TimelineEmpty onAddClick={mockOnAddClick} />);
  ...
  describe('Accessibility', () => {
    it('should have accessible button with proper role', () => {
      ...
      const button = screen.getByRole('button', { name: /add your first deadline/i });
  ...
  describe('Content', () => {
    it('should display motivational text for first-time users', () => {
      ...
      expect(screen.getByText(/no deadlines yet/i)).toBeInTheDocument();
      expect(
        screen.getByText(/track important dates and deadlines for your legal cases/i),
      ).toBeInTheDocument();
    });
