...
export class UserFactory {
   ...
   */
  static createTestCredentials(overrides?: {
    username?: string;
    password?: string;
    email?: string;
  }) {
    ...
    return {
      ...
      password: overrides?.password ?? generateStrongTestPassword(),
    };
  }
  ...
  static createWeakPasswordCredentials() {
    return {
      ...
      password: generatePasswordOfLength(8), // Intentionally below 12-char OWASP guideline
    };
  }
  ...
  static createNoUppercasePasswordCredentials() {
    return {
      username: `testuser_${uuidv4().slice(0, 8)}`,
      email: `test_${uuidv4().slice(0, 8)}@example.com`,
      password: generatePasswordWithoutUppercase(),
    };
  }
  ...
  static createNoLowercasePasswordCredentials() {
    return {
      username: `testuser_${uuidv4().slice(0, 8)}`,
      email: `test_${uuidv4().slice(0, 8)}@example.com`,
      password: generatePasswordWithoutLowercase(),
    };
  }
  ...
  static createNoNumberPasswordCredentials() {
    return {
      username: `testuser_${uuidv4().slice(0, 8)}`,
      email: `test_${uuidv4().slice(0, 8)}@example.com`,
      password: generatePasswordWithoutDigits(),
    };
  }
}
...
export class MockDataGenerator {
  ...
  static generateStrongPassword(): string {
    return generateStrongTestPassword();
  }
