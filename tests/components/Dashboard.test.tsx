...
describe('Dashboard', () => {
  ...
  test('renders all quick action buttons', () => {
    ...
    expect(screen.getByRole('button', { name: /start chat|ai assistant/i })).toBeInTheDocument();
  });
  ...
  test('calls callbacks when quick action buttons are clicked', () => {
    ...
    fireEvent.click(screen.getByRole('button', { name: /start chat|ai assistant/i }));
  ...
  test('renders recent cases list', () => {
    const recentCases = [
      { id: '1', title: 'Case Alpha', status: 'active', lastUpdated: '2025-01-01' },
      { id: '2', title: 'Case Beta', status: 'closed', lastUpdated: '2025-01-02' }
    ];
  ...
  test('calls onCaseClick when a case is clicked', () => {
    ...
    render(<Dashboard username="User" recentCases={recentCases} onCaseClick={mockCaseClick} />);
  ...
  test('shows descriptive labels for each stat', () => {
    ...
    expect(screen.getByText(/evidence items|total evidence/i)).toBeInTheDocument();
  });
  ...
  test('recent cases section has descriptive heading', () => {
    ...
    expect(screen.getByRole('heading', { name: /recent cases/i })).toBeInTheDocument();
  });
  ...
  test('formats dates in recent cases list', () => {
    const recentCases = [
      { id: '1', title: 'Case Alpha', status: 'active', lastUpdated: '2025-01-15' }
    ];
