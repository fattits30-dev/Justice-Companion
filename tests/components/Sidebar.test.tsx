...
describe('Sidebar', () => {
  ...
  test('renders all navigation links', () => {
    ...
    expect(screen.getByRole('link', { name: /documents|evidence/i })).toBeInTheDocument();
  ...
  test('calls onLogout when logout button is clicked', () => {
    ...
    render(<Sidebar currentRoute="/dashboard" user={user} onLogout={mockLogout} />);
  ...
  test('can be collapsed and expanded', () => {
    render(<Sidebar currentRoute="/dashboard" isCollapsed={false} onToggleCollapse={vi.fn()} />);
  ...
  test('calls onToggleCollapse when toggle button is clicked', () => {
    ...
    render(<Sidebar currentRoute="/dashboard" isCollapsed={false} onToggleCollapse={mockToggle} />);
