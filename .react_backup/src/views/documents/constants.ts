...
> = {
  document: {
    label: "Document",
    shortLabel: "DOC",
    accent: "bg-blue-900 text-blue-200",
  },
  photo: {
    label: "Photo",
    shortLabel: "IMG",
  ...
  email: {
    label: "Email",
    shortLabel: "EML",
    accent: "bg-teal-900 text-teal-200",
  },
  recording: {
    label: "Recording",
    shortLabel: "AUD",
  ...
  note: {
    label: "Note",
    shortLabel: "NOTE",
    accent: "bg-rose-900 text-rose-200",
  },
  witness: {
    label: "Witness",
    shortLabel: "WIT",
    accent: "bg-slate-900 text-slate-200",
  },
};

export const evidenceFilterOptions: Array<{
