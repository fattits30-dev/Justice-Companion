  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'primary': '0 10px 40px -10px rgba(59, 130, 246, 0.4)',
        'primary-lg': '0 20px 60px -15px rgba(59, 130, 246, 0.5)',
        'secondary': '0 10px 40px -10px rgba(139, 92, 246, 0.4)',
        'secondary-lg': '0 20px 60px -15px rgba(139, 92, 246, 0.5)',
        'success': '0 10px 40px -10px rgba(34, 197, 94, 0.4)',
        'warning': '0 10px 40px -10px rgba(245, 158, 11, 0.4)',
        'danger': '0 10px 40px -10px rgba(239, 68, 68, 0.4)',
